// Navigation Component - iSKKOLAR Applicant Portal
// This file contains the shared header and bottom navigation for applicant pages
    ...
    <header class="topbar">
      ...
      <div class="topbar-right">
        ...
        <a href="profile.html" class="user-menu">
          ...
          <div class="user-info">
            <span class="user-name">Mario Veluz</span>
...
function getActivePageFromURL() {
  ...
  if (filename === 'application.html') return 'application';
  if (filename === 'notifications.html') return 'notifications';
